...
> **Picture goes here (#3).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `String logMessage = "Username: " + username + " and Password: " + password + " are verified";`.
> _Save as_ `images/androgoat-walkthrough/3.png` _then replace this block with_ `![2. Insecure logging](/images/androgoat-walkthrough/3.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/4.png` _then replace this block with_ `![2. Insecure logging](/images/androgoat-walkthrough/4.png)`_._

## 3. Insecure data storage

Four variants store credentials unsafely.
> **Picture goes here (#5).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `SharedPreferences sp = getSharedPreferences("users", 0);`.
> _Save as_ `images/androgoat-walkthrough/5.png` _then replace this block with_ `![3. Insecure data storage](/images/androgoat-walkthrough/5.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/6.png` _then replace this block with_ `![3. Insecure data storage](/images/androgoat-walkthrough/6.png)`_._
...
> **Picture goes here (#7).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `ClipboardActivity`.
> _Save as_ `images/androgoat-walkthrough/7.png` _then replace this block with_ `![4. Side-channel data leakage](/images/androgoat-walkthrough/7.png)`_._


> **Picture goes here (#8).** Capture the result that proves this exercise (app screen, logcat, file contents or Frida output).
> _Save as_ `images/androgoat-walkthrough/8.png` _then replace this block with_ `![4. Side-channel data leakage](/images/androgoat-walkthrough/8.png)`_._

## 5. Root detection

`RootDetectionActivity` checks for `su` binaries and Superuser/Xposed paths:
> **Picture goes here (#9).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `String[] file = {"/system/app/Superuser.apk", "/sbin/su", "/system/bin/su",`.
> _Save as_ `images/androgoat-walkthrough/9.png` _then replace this block with_ `![5. Root detection](/images/androgoat-walkthrough/9.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/10.png` _then replace this block with_ `![5. Root detection](/images/androgoat-walkthrough/10.png)`_._

## 6. Emulator detection

`EmulatorDetectionActivity` greps build properties for emulator indicators:
> **Picture goes here (#11).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `String buildDetails = (Build.FINGERPRINT + Build.DEVICE + Build.MODEL + Build.BRAND`.
> _Save as_ `images/androgoat-walkthrough/11.png` _then replace this block with_ `![6. Emulator detection](/images/androgoat-walkthrough/11.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/12.png` _then replace this block with_ `![6. Emulator detection](/images/androgoat-walkthrough/12.png)`_._

## 7. Binary patching

`BinaryPatchingActivity` gates the admin button behind a `boolean isAdmin` that is effectively false:
> **Picture goes here (#13).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `private final boolean isAdmin;`.
> _Save as_ `images/androgoat-walkthrough/13.png` _then replace this block with_ `![7. Binary patching](/images/androgoat-walkthrough/13.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/14.png` _then replace this block with_ `![7. Binary patching](/images/androgoat-walkthrough/14.png)`_._
...
> **Picture goes here (#15).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `BioMetricAuthActivity`.
> _Save as_ `images/androgoat-walkthrough/15.png` _then replace this block with_ `![8. Biometric authentication](/images/androgoat-walkthrough/15.png)`_._


> **Picture goes here (#16).** Capture the result that proves this exercise (app screen, logcat, file contents or Frida output).
> _Save as_ `images/androgoat-walkthrough/16.png` _then replace this block with_ `![8. Biometric authentication](/images/androgoat-walkthrough/16.png)`_._
...
> **Picture goes here (#17).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `<activity android:name="owasp.sat.agoat.AccessControl1ViewActivity" android:exported="true">`.
> _Save as_ `images/androgoat-walkthrough/17.png` _then replace this block with_ `![9. Unprotected Android components (access control)](/images/androgoat-walkthrough/17.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/18.png` _then replace this block with_ `![9. Unprotected Android components (access control)](/images/androgoat-walkthrough/18.png)`_._
...
> **Picture goes here (#19).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `adb shell content query --uri content://owasp.sat.agoat.provider.userpinsprovider/user_pins`.
> _Save as_ `images/androgoat-walkthrough/19.png` _then replace this block with_ `![10. Content Provider](/images/androgoat-walkthrough/19.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/20.png` _then replace this block with_ `![10. Content Provider](/images/androgoat-walkthrough/20.png)`_._

## 11. Broadcast Receiver

`ShowDataReceiver` is exported and leaks credentials in a toast:
> **Picture goes here (#21).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `ShowDataReceiver`.
> _Save as_ `images/androgoat-walkthrough/21.png` _then replace this block with_ `![11. Broadcast Receiver](/images/androgoat-walkthrough/21.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/22.png` _then replace this block with_ `![11. Broadcast Receiver](/images/androgoat-walkthrough/22.png)`_._
...
> **Picture goes here (#23).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `String htmlData = "<html><body>...<p>Product ID: <b>" + scannedText + "</b></p>...";`.
> _Save as_ `images/androgoat-walkthrough/23.png` _then replace this block with_ `![12. WebView / QR XSS](/images/androgoat-walkthrough/23.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/24.png` _then replace this block with_ `![12. WebView / QR XSS](/images/androgoat-walkthrough/24.png)`_._

## 13. SQL Injection

`SQLinjectionActivity` concatenates the search term into a raw query over the `aGoat` database's `users` table:
> **Picture goes here (#25).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `String qry = "SELECT * FROM users WHERE username='" + username + "'";`.
> _Save as_ `images/androgoat-walkthrough/25.png` _then replace this block with_ `![13. SQL Injection](/images/androgoat-walkthrough/25.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/26.png` _then replace this block with_ `![13. SQL Injection](/images/androgoat-walkthrough/26.png)`_._

## 14. Input validation — OS command injection

`InputValidationsOSCMDInjectionMain2Activity` shells out with the user's input:
> **Picture goes here (#27).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `String ip1 = "ping " + ip.getText();`.
> _Save as_ `images/androgoat-walkthrough/27.png` _then replace this block with_ `![14. Input validation — OS command injection](/images/androgoat-walkthrough/27.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/28.png` _then replace this block with_ `![14. Input validation — OS command injection](/images/androgoat-walkthrough/28.png)`_._

## 15. Input validation — WebView file access

`InputValidationsWebViewURLActivity` enables dangerous WebView settings:
> **Picture goes here (#29).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `webViewSettings.setJavaScriptEnabled(true);`.
> _Save as_ `images/androgoat-walkthrough/29.png` _then replace this block with_ `![15. Input validation — WebView file access](/images/androgoat-walkthrough/29.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/30.png` _then replace this block with_ `![15. Input validation — WebView file access](/images/androgoat-walkthrough/30.png)`_._

## 16. Network traffic / certificate pinning

The network security config permits cleartext and user CAs, and pins only `cve.org`:
> **Picture goes here (#31).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `<base-config cleartextTrafficPermitted="true">`.
> _Save as_ `images/androgoat-walkthrough/31.png` _then replace this block with_ `![16. Network traffic / certificate pinning](/images/androgoat-walkthrough/31.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/32.png` _then replace this block with_ `![16. Network traffic / certificate pinning](/images/androgoat-walkthrough/32.png)`_._

## 17. Cloud services

`CloudServicesActivity` (covered in #1) is the AWS exercise; it also logs the keys:
> **Picture goes here (#33).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `CloudServicesActivity`.
> _Save as_ `images/androgoat-walkthrough/33.png` _then replace this block with_ `![17. Cloud services](/images/androgoat-walkthrough/33.png)`_._
...
> _Save as_ `images/androgoat-walkthrough/34.png` _then replace this block with_ `![17. Cloud services](/images/androgoat-walkthrough/34.png)`_._
