...
> **Picture goes here (#3).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `if (hckey.getText().toString().equals("vendorsecretkey")) {`.
> _Save as_ `images/diva-walkthrough/3.png` _then replace this block with_ `![Challenge 2 — Hardcoding Issues (Part 1)](/images/diva-walkthrough/3.png)`_._
...
> _Save as_ `images/diva-walkthrough/4.png` _then replace this block with_ `![Challenge 2 — Hardcoding Issues (Part 1)](/images/diva-walkthrough/4.png)`_._

## Challenge 3 — Insecure Data Storage (Part 1)

Credentials are written to `SharedPreferences` in plaintext:
> **Picture goes here (#5).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `SharedPreferences spref = PreferenceManager.getDefaultSharedPreferences(this);`.
> _Save as_ `images/diva-walkthrough/5.png` _then replace this block with_ `![Challenge 3 — Insecure Data Storage (Part 1)](/images/diva-walkthrough/5.png)`_._
...
> _Save as_ `images/diva-walkthrough/6.png` _then replace this block with_ `![Challenge 3 — Insecure Data Storage (Part 1)](/images/diva-walkthrough/6.png)`_._
...
> **Picture goes here (#7).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `mDB.execSQL("INSERT INTO myuser VALUES ('"+ usr.getText() +"', '"+ pwd.getText() +"');");`.
> _Save as_ `images/diva-walkthrough/7.png` _then replace this block with_ `![Challenge 4 — Insecure Data Storage (Part 2)](/images/diva-walkthrough/7.png)`_._
...
> _Save as_ `images/diva-walkthrough/8.png` _then replace this block with_ `![Challenge 4 — Insecure Data Storage (Part 2)](/images/diva-walkthrough/8.png)`_._

## Challenge 5 — Insecure Data Storage (Part 3)

A temporary file is created in the app's `dataDir` with world read/write:
> **Picture goes here (#9).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `File uinfo = File.createTempFile("uinfo", "tmp", ddir);`.
> _Save as_ `images/diva-walkthrough/9.png` _then replace this block with_ `![Challenge 5 — Insecure Data Storage (Part 3)](/images/diva-walkthrough/9.png)`_._
...
> _Save as_ `images/diva-walkthrough/10.png` _then replace this block with_ `![Challenge 5 — Insecure Data Storage (Part 3)](/images/diva-walkthrough/10.png)`_._

## Challenge 6 — Insecure Data Storage (Part 4)

This one writes to **external storage** at `/.uinfo.txt`:
> **Picture goes here (#11).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `File sdir = Environment.getExternalStorageDirectory();`.
> _Save as_ `images/diva-walkthrough/11.png` _then replace this block with_ `![Challenge 6 — Insecure Data Storage (Part 4)](/images/diva-walkthrough/11.png)`_._
...
> _Save as_ `images/diva-walkthrough/12.png` _then replace this block with_ `![Challenge 6 — Insecure Data Storage (Part 4)](/images/diva-walkthrough/12.png)`_._

## Challenge 7 — Input Validation Issues (Part 1) — SQL Injection

`SQLInjectionActivity` builds a raw query by concatenation:
> **Picture goes here (#13).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `SQLInjectionActivity`.
> _Save as_ `images/diva-walkthrough/13.png` _then replace this block with_ `![Challenge 7 — Input Validation Issues (Part 1) — SQL Injection](/images/diva-walkthrough/13.png)`_._
...
> _Save as_ `images/diva-walkthrough/14.png` _then replace this block with_ `![Challenge 7 — Input Validation Issues (Part 1) — SQL Injection](/images/diva-walkthrough/14.png)`_._
...
> **Picture goes here (#15).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `WebSettings wset = wview.getSettings();`.
> _Save as_ `images/diva-walkthrough/15.png` _then replace this block with_ `![Challenge 8 — Input Validation Issues (Part 2) — WebView](/images/diva-walkthrough/15.png)`_._
...
> _Save as_ `images/diva-walkthrough/16.png` _then replace this block with_ `![Challenge 8 — Input Validation Issues (Part 2) — WebView](/images/diva-walkthrough/16.png)`_._

## Challenge 9 — Access Control Issues (Part 1)

`APICredsActivity` is exported through an implicit intent-filter:
> **Picture goes here (#17).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `<activity android:name=".APICredsActivity">`.
> _Save as_ `images/diva-walkthrough/17.png` _then replace this block with_ `![Challenge 9 — Access Control Issues (Part 1)](/images/diva-walkthrough/17.png)`_._
...
> _Save as_ `images/diva-walkthrough/18.png` _then replace this block with_ `![Challenge 9 — Access Control Issues (Part 1)](/images/diva-walkthrough/18.png)`_._
...
> **Picture goes here (#19).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `boolean bcheck = i.getBooleanExtra(getString(R.string.chk_pin), true);`.
> _Save as_ `images/diva-walkthrough/19.png` _then replace this block with_ `![Challenge 10 — Access Control Issues (Part 2)](/images/diva-walkthrough/19.png)`_._
...
> _Save as_ `images/diva-walkthrough/20.png` _then replace this block with_ `![Challenge 10 — Access Control Issues (Part 2)](/images/diva-walkthrough/20.png)`_._

## Challenge 11 — Access Control Issues (Part 3) — Content Provider

`NotesProvider` is exported and unauthenticated:
> **Picture goes here (#21).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `<provider`.
> _Save as_ `images/diva-walkthrough/21.png` _then replace this block with_ `![Challenge 11 — Access Control Issues (Part 3) — Content Provider](/images/diva-walkthrough/21.png)`_._
...
> _Save as_ `images/diva-walkthrough/22.png` _then replace this block with_ `![Challenge 11 — Access Control Issues (Part 3) — Content Provider](/images/diva-walkthrough/22.png)`_._
...
> **Picture goes here (#23).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `#define VENDORKEY   "olsdfgad;lh"`.
> _Save as_ `images/diva-walkthrough/23.png` _then replace this block with_ `![Challenge 12 — Hardcoding Issues (Part 2) — Native](/images/diva-walkthrough/23.png)`_._
...
> _Save as_ `images/diva-walkthrough/24.png` _then replace this block with_ `![Challenge 12 — Hardcoding Issues (Part 2) — Native](/images/diva-walkthrough/24.png)`_._
...
> **Picture goes here (#25).** Capture a Burp/adb/Frida screenshot for this exercise showing the payload or command you run. Key payload/command: `#define CODESIZEMAX 20`.
> _Save as_ `images/diva-walkthrough/25.png` _then replace this block with_ `![Challenge 13 — Input Validation Issues (Part 3) — Buffer Overflow](/images/diva-walkthrough/25.png)`_._
...
> _Save as_ `images/diva-walkthrough/26.png` _then replace this block with_ `![Challenge 13 — Input Validation Issues (Part 3) — Buffer Overflow](/images/diva-walkthrough/26.png)`_._
