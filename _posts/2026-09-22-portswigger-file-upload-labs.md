...
> **[Screenshot]** The uploaded avatar request in Burp and its response containing the secret.
...
> **[Screenshot]** The modified multipart request with `Content-Type: image/jpeg` and the PHP body.
...
> **[Screenshot]** The `.htaccess` upload followed by the executed `.l33t` shell.
...
> **[Screenshot]** The polyglot response with `START <secret> END` in the image data.
...
> **[Screenshot]** Turbo Intruder results showing 200 responses containing the secret.
