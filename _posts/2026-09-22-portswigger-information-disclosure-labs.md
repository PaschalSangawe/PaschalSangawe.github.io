...
> **[Screenshot]** The stack trace in the response showing the Struts version.
...
> **[Screenshot]** The `/cgi-bin/phpinfo.php` output exposing `SECRET_KEY`.
...
> **[Screenshot]** The spoofed header granting access to `/admin`, then deleting carlos.
...
> **[Screenshot]** `ProductTemplate.java.bak` showing the hard-coded DB password.
...
> **[Screenshot]** `git show` output displaying the pre-change admin password.
